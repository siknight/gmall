...
import mock.util.{LogUpload, RandomNumUtil, RandomOptions}
...
//        val mid: String = "mid_" + RandomNumUtil.randomInt(1, 10)
        val mid: String = "mid_" + RandomNumUtil.randomInt(1, 30)
        val uid: String = "uid_" + RandomNumUtil.randomInt(1, 30)
